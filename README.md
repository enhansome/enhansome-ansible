...
* [AWX](https://github.com/ansible/awx) ⭐ 15,543 | 🐛 1,869 | 🌐 Python | 📅 2026-09-02 - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,091 | 🐛 1,082 | 🌐 Go | 📅 2026-09-02 - Modern UI for managing and running Ansible playbooks.
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,903 | 🐛 112 | 🌐 Python | 📅 2026-09-02 - Checks Playbooks for best practices and behavior that could potentially be improved.
...
* [ansible-navigator](https://github.com/ansible/ansible-navigator) ⭐ 547 | 🐛 104 | 🌐 Python | 📅 2026-09-02 - A text-based user interface (TUI) for Ansible.
...
* [Ansible Doctor](https://github.com/thegeeklab/ansible-doctor) ⭐ 157 | 🐛 4 | 🌐 Python | 📅 2026-09-02 - Simple annotation like documentation generator for Ansible roles based on Jinja2 templates.
...
* [aar-doc - Automated Ansible Role Documentation](https://github.com/telekom-mms/Automated-Ansible-Role-Documentation) ⭐ 53 | 🐛 9 | 🌐 Python | 📅 2026-09-02 - Generate documentation automatically from an Ansible role's metadata.
...
* [Testing Ansible Roles Against Windows with Test-Kitchen](https://hodgkins.io/testing-ansible-roles-windows-test-kitchen) - Using Test-Kitchen with Ansible to apply playbooks to Windows machines and test them with [Pester](https://github.com/pester/Pester/) ⭐ 3,329 | 🐛 72 | 🌐 PowerShell | 📅 2026-08-30.
...
* [BlueBanquise](https://github.com/bluebanquise/bluebanquise) ⭐ 163 | 🐛 39 | 🌐 Python | 📅 2026-08-27 - An Ansible coherent roles collection to deploy clusters.
...
* [Linuxfabrik LFOps](https://github.com/Linuxfabrik/lfops) ⭐ 87 | 🐛 33 | 🌐 Jinja | 📅 2026-09-02 - An Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure (RHEL 8/9/10, Debian, Ubuntu). Covers OS hardening, MariaDB, Icinga2, Nextcloud, FreeIPA, KVM and Bitwarden integration.
