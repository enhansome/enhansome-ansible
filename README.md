...
* [Ansible For DevOps](https://github.com/geerlingguy/ansible-for-devops) ⭐ 9,856 | 🐛 118 | 🌐 Python | 📅 2025-05-25 - This repository contains Ansible examples developed to support different sections of `Ansible for DevOps` by Jeff Geerling, which is listed in the following section of books about Ansible.
...
* [AWX](https://github.com/ansible/awx) ⭐ 15,526 | 🐛 1,870 | 🌐 Python | 📅 2026-08-14 - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,020 | 🐛 1,064 | 🌐 Go | 📅 2026-08-16 - Modern UI for managing and running Ansible playbooks.
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,898 | 🐛 121 | 🌐 Python | 📅 2026-08-14 - Checks Playbooks for best practices and behavior that could potentially be improved.
...
* [ansible-navigator](https://github.com/ansible/ansible-navigator) ⭐ 545 | 🐛 117 | 🌐 Python | 📅 2026-08-16 - A text-based user interface (TUI) for Ansible.
...
* [BlueBanquise](https://github.com/bluebanquise/bluebanquise) ⭐ 163 | 🐛 36 | 🌐 Jinja | 📅 2026-08-16 - An Ansible coherent roles collection to deploy clusters.
...
* [Emacs](https://www.gnu.org/software/emacs/) - A free, open-source text editor and IDE that supports auto-indentation, syntax highlighting and a built in terminal shell (among other things):
  * [magit-mode](https://github.com/magit/magit) ⭐ 7,203 | 🐛 14 | 🌐 Emacs Lisp | 📅 2026-08-15 - Git porcelain within Emacs.
