...
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,049 | 🐛 1,069 | 🌐 Go | 📅 2026-08-21 - Modern UI for managing and running Ansible playbooks.
...
* [kics](https://github.com/Checkmarx/kics) ⭐ 2,692 | 🐛 326 | 🌐 Open Policy Agent | 📅 2026-08-23 - SAST Tool that scans your Ansible infrastructure as code playbooks for security vulnerabilities, compliance issues and misconfigurations.
* [ARA](https://github.com/ansible-community/ara) ⭐ 2,018 | 🐛 133 | 🌐 Python | 📅 2026-07-13 - Records Ansible playbooks and makes them easier to understand and troubleshoot with a reporting API, UI and CLI.
...
* [ansible-navigator](https://github.com/ansible/ansible-navigator) ⭐ 546 | 🐛 117 | 🌐 Python | 📅 2026-08-23 - A text-based user interface (TUI) for Ansible.
