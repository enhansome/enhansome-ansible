...
* [Ansible For DevOps](https://github.com/geerlingguy/ansible-for-devops) ⭐ 9,880 | 🐛 119 | 🌐 Python | 📅 2025-05-25 - This repository contains Ansible examples developed to support different sections of `Ansible for DevOps` by Jeff Geerling, which is listed in the following section of books about Ansible.
...
* [AWX](https://github.com/ansible/awx) ⭐ 15,545 | 🐛 1,872 | 🌐 Python | 📅 2026-09-07 - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,105 | 🐛 1,071 | 🌐 Go | 📅 2026-09-07 - Modern UI for managing and running Ansible playbooks.
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,906 | 🐛 112 | 🌐 Python | 📅 2026-09-07 - Checks Playbooks for best practices and behavior that could potentially be improved.
* [kics](https://github.com/Checkmarx/kics) ⭐ 2,698 | 🐛 317 | 🌐 Open Policy Agent | 📅 2026-09-07 - SAST Tool that scans your Ansible infrastructure as code playbooks for security vulnerabilities, compliance issues and misconfigurations.
...
* [ansible-security-scanner](https://github.com/cpeoples/ansible-security-scanner) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - Static analyzer for playbooks, roles and collections covering hardcoded credentials, RCE, and supply-chain risks. Outputs SARIF, CycloneDX SBOM and GitLab SAST.
...
* [Openstack Ansible](https://github.com/openstack/openstack-ansible) ⭐ 1,560 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Ansible Playbooks for deploying [OpenStack](https://www.openstack.org/).
...
* [BlueBanquise](https://github.com/bluebanquise/bluebanquise) ⭐ 163 | 🐛 37 | 🌐 Python | 📅 2026-09-04 - An Ansible coherent roles collection to deploy clusters.
...
* [Linuxfabrik LFOps](https://github.com/Linuxfabrik/lfops) ⭐ 90 | 🐛 33 | 🌐 Jinja | 📅 2026-09-04 - An Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure (RHEL 8/9/10, Debian, Ubuntu). Covers OS hardening, MariaDB, Icinga2, Nextcloud, FreeIPA, KVM and Bitwarden integration.
