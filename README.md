...
* [AWX](https://github.com/ansible/awx) ⭐ 15,545 | 🐛 1,869 | 🌐 Python | 📅 2026-09-03 - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,094 | 🐛 1,081 | 🌐 Go | 📅 2026-09-03 - Modern UI for managing and running Ansible playbooks.
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,905 | 🐛 111 | 🌐 Python | 📅 2026-09-03 - Checks Playbooks for best practices and behavior that could potentially be improved.
* [kics](https://github.com/Checkmarx/kics) ⭐ 2,699 | 🐛 316 | 🌐 Open Policy Agent | 📅 2026-09-03 - SAST Tool that scans your Ansible infrastructure as code playbooks for security vulnerabilities, compliance issues and misconfigurations.
...
* [BlueBanquise](https://github.com/bluebanquise/bluebanquise) ⭐ 163 | 🐛 39 | 🌐 Python | 📅 2026-09-03 - An Ansible coherent roles collection to deploy clusters.
...
* [Linuxfabrik LFOps](https://github.com/Linuxfabrik/lfops) ⭐ 87 | 🐛 35 | 🌐 Jinja | 📅 2026-09-03 - An Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure (RHEL 8/9/10, Debian, Ubuntu). Covers OS hardening, MariaDB, Icinga2, Nextcloud, FreeIPA, KVM and Bitwarden integration.
