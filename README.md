...
* [Ansible For DevOps](https://github.com/geerlingguy/ansible-for-devops) ⭐ 9,887 | 🐛 119 | 🌐 Python | 📅 2025-05-25 - This repository contains Ansible examples developed to support different sections of `Ansible for DevOps` by Jeff Geerling, which is listed in the following section of books about Ansible.
...
* [AWX](https://github.com/ansible/awx) ⭐ 15,567 | 🐛 1,872 | 🌐 Python | 📅 2026-09-22 - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,177 | 🐛 1,043 | 🌐 Go | 📅 2026-09-22 - Modern UI for managing and running Ansible playbooks.
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,911 | 🐛 108 | 🌐 Python | 📅 2026-09-22 - Checks Playbooks for best practices and behavior that could potentially be improved.
* [kics](https://github.com/Checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-22 - SAST Tool that scans your Ansible infrastructure as code playbooks for security vulnerabilities, compliance issues and misconfigurations.
...
* [ansible-runner](https://github.com/ansible/ansible-runner) ⭐ 1,085 | 🐛 105 | 🌐 Python | 📅 2026-09-10 - A tool and Python library that helps when interfacing with Ansible directly or as part of another system whether that be through a container image interface, as a standalone tool, or as a Python module that can be imported.
* [Ansible Playbook Grapher](https://github.com/haidaraM/ansible-playbook-grapher) ⭐ 763 | 🐛 5 | 🌐 Python | 📅 2026-09-03 - Command line tool to create a graph representing your Ansible playbook plays, tasks and roles.
* [ansible-navigator](https://github.com/ansible/ansible-navigator) ⭐ 550 | 🐛 101 | 🌐 Python | 📅 2026-09-21 - A text-based user interface (TUI) for Ansible.
...
* [TD4A](https://github.com/cidrblock/td4a) ⭐ 222 | 🐛 5 | 🌐 CSS | 📅 2023-12-19 - Design aid for building and testing jinja2 templates, combines data in yaml format with a jinja2 template and render the output.
...
* [Ansible Doctor](https://github.com/thegeeklab/ansible-doctor) ⭐ 157 | 🐛 4 | 🌐 Python | 📅 2026-09-22 - Simple annotation like documentation generator for Ansible roles based on Jinja2 templates.
...
* [aar-doc - Automated Ansible Role Documentation](https://github.com/telekom-mms/Automated-Ansible-Role-Documentation) ⭐ 54 | 🐛 10 | 🌐 Python | 📅 2026-09-18 - Generate documentation automatically from an Ansible role's metadata.
* [ansible-static-lint](https://github.com/arhuman/ansible-static-lint) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Fast, offline static linter for playbooks written in Go, implementing a subset of ansible-lint rules without requiring Python or an Ansible runtime.
...
* [Ansible DocSmith](https://github.com/foundata/ansible-docsmith) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Generates Ansible role documentation from argument\_specs.yml for READMEs and default variable files.
...
* [ansible-security-scanner](https://github.com/cpeoples/ansible-security-scanner) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Static analyzer for playbooks, roles and collections covering hardcoded credentials, RCE, and supply-chain risks. Outputs SARIF, CycloneDX SBOM and GitLab SAST.
* [antsichaut](https://github.com/ansible-community/antsichaut) ⭐ 5 | 🐛 8 | 🌐 Python | 📅 2026-09-21 - Automate the filling of a changelog.yaml used by antsibull-changelog.
...
* [Testing Ansible Roles Against Windows with Test-Kitchen](https://hodgkins.io/testing-ansible-roles-windows-test-kitchen) - Using Test-Kitchen with Ansible to apply playbooks to Windows machines and test them with [Pester](https://github.com/pester/Pester/) ⭐ 3,345 | 🐛 66 | 🌐 PowerShell | 📅 2026-09-09.
...
* [Openstack Ansible](https://github.com/openstack/openstack-ansible) ⭐ 1,561 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Ansible Playbooks for deploying [OpenStack](https://www.openstack.org/).
...
* [BlueBanquise](https://github.com/bluebanquise/bluebanquise) ⭐ 164 | 🐛 37 | 🌐 Python | 📅 2026-09-22 - An Ansible coherent roles collection to deploy clusters.
...
* [Linuxfabrik LFOps](https://github.com/Linuxfabrik/lfops) ⭐ 91 | 🐛 49 | 🌐 Jinja | 📅 2026-09-22 - An Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure (RHEL 8/9/10, Debian, Ubuntu). Covers OS hardening, MariaDB, Icinga2, Nextcloud, FreeIPA, KVM and Bitwarden integration.
...
* [Ansible Language Server](https://github.com/ansible/ansible-language-server) ⚠️ Archived - Language Server that adds support for Ansible, to compatible Editors.
...
* [Emacs](https://www.gnu.org/software/emacs/) - A free, open-source text editor and IDE that supports auto-indentation, syntax highlighting and a built in terminal shell (among other things):
  * [magit-mode](https://github.com/magit/magit) ⭐ 7,233 | 🐛 12 | 🌐 Emacs Lisp | 📅 2026-09-21 - Git porcelain within Emacs.
