...
* [AWX](https://github.com/ansible/awx) ⭐ 15,567 | 🐛 1,872 | 🌐 Python | 📅 2026-09-21 - Web-based user interface, REST API, and task engine built on top of Ansible. It is the upstream project for Automation Controller.
* [Ansible Semaphore](https://github.com/ansible-semaphore/semaphore) ⭐ 14,171 | 🐛 1,037 | 🌐 Go | 📅 2026-09-21 - Modern UI for managing and running Ansible playbooks.
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,911 | 🐛 108 | 🌐 Python | 📅 2026-09-21 - Checks Playbooks for best practices and behavior that could potentially be improved.
* [kics](https://github.com/Checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-21 - SAST Tool that scans your Ansible infrastructure as code playbooks for security vulnerabilities, compliance issues and misconfigurations.
...
* [ansible-navigator](https://github.com/ansible/ansible-navigator) ⭐ 550 | 🐛 102 | 🌐 Python | 📅 2026-09-21 - A text-based user interface (TUI) for Ansible.
...
* [Ansible Doctor](https://github.com/thegeeklab/ansible-doctor) ⭐ 157 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - Simple annotation like documentation generator for Ansible roles based on Jinja2 templates.
...
* [Ansible DocSmith](https://github.com/foundata/ansible-docsmith) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - Generates Ansible role documentation from argument\_specs.yml for READMEs and default variable files.
...
* [Testing Ansible Roles Against Windows with Test-Kitchen](https://hodgkins.io/testing-ansible-roles-windows-test-kitchen) - Using Test-Kitchen with Ansible to apply playbooks to Windows machines and test them with [Pester](https://github.com/pester/Pester/) ⭐ 3,343 | 🐛 66 | 🌐 PowerShell | 📅 2026-09-09.
...
* [BlueBanquise](https://github.com/bluebanquise/bluebanquise) ⭐ 164 | 🐛 36 | 🌐 Python | 📅 2026-09-16 - An Ansible coherent roles collection to deploy clusters.
...
* [Linuxfabrik LFOps](https://github.com/Linuxfabrik/lfops) ⭐ 91 | 🐛 48 | 🌐 Jinja | 📅 2026-09-18 - An Ansible Collection with 145+ playbooks and 160+ roles to bootstrap and manage Linux infrastructure (RHEL 8/9/10, Debian, Ubuntu). Covers OS hardening, MariaDB, Icinga2, Nextcloud, FreeIPA, KVM and Bitwarden integration.
...
* [Emacs](https://www.gnu.org/software/emacs/) - A free, open-source text editor and IDE that supports auto-indentation, syntax highlighting and a built in terminal shell (among other things):
  * [magit-mode](https://github.com/magit/magit) ⭐ 7,232 | 🐛 13 | 🌐 Emacs Lisp | 📅 2026-09-20 - Git porcelain within Emacs.
